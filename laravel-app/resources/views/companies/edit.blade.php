...
@section('content')
    <div class="container">
        ...
        @endif
        <form method="post" action="{{ route('dashboardcompanies.update', ['company' => $company])}}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="tel" class="form-control" id="phone" name="phone" aria-describedby="phoneHelp" value="{{ $company->phone }}">
